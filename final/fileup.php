...
<footer>
        <nav class="navbar navbar-default">
          ...
          <a href="file_chek.html" id="select_btn" class="btn btn-primary btn-lg">◀戻る</a>
          <div align="right"><a href="map_view.php" id="select_btn" class="btn btn-primary btn-lg">地図を見てみる▶</a></div>
        </nav>
</footer>
</body>
</html>